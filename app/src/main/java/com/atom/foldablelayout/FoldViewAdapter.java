package com.atom.foldablelayout;
 ...
 * 适配器
 */
public class FoldViewAdapter extends RecyclerView.Adapter<FoldViewAdapter.PhotoViewHolder> {

    private String[] mDataSet;
    private Map<Integer, Boolean> mFoldStates = new HashMap<>();
    private Context mContext;

    public FoldViewAdapter(Context context, String[] dataSet) {
